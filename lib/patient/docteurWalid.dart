...
class DocteurWalid extends StatefulWidget {
  const DocteurWalid({super.key});

  @override
  State<DocteurWalid> createState() => _DocteurWalidState();
}

class _DocteurWalidState extends State<DocteurWalid> {
  @override
      ...
      body: ListView(
        children: [
          ...
          Padding(
            ...
            child: Text(
              " Dr. Walid houaijia, orthophoniste dévoué, offre des interventions spécialisées pour surmonter les défis liés à la parole, à la voix et au langage. Grâce à son approche bienveillante, il crée un environnement favorable à l'épanouissement de ses patients, intégrant des méthodes innovantes pour une communication optimale.",
              style: TextStyle(
                  fontWeight: FontWeight.w400,
                  fontSize: 14,
                  color: Colors.grey),
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: Column(children: [
                  ...
                  Text("Le Dr. Walid est un orthophoniste exceptionnel ")
                ]),
              ),
            ),
          ),
            ...
            child: Container(
              ...
              child: Padding(
                ...
                child: Column(children: [
                  ...
                  Text(
                      "Nous sommes reconnaissants pour votre expertise et  dévouement.")
                ]),
              ),
            ),
          ),
