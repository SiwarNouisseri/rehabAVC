...
class ResetPatient extends StatefulWidget {
  const ResetPatient({Key? key}) : super(key: key);

  @override
  State<ResetPatient> createState() => _ResetPatientState();
}

class _ResetPatientState extends State<ResetPatient> {
