                ...
                Container(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, int index) {
                      ...
                      var prenomDoc = document.get('prenom de docteur');
                      var nomDoc = document.get('nom de docteur');
                      var prenom = document.get('prenom de patient');
                      var temps = document.get('timestamp');
                      var idPatient = document.get('id de patient');
                      var idDoc = document.get('id de docteur');
                      var imageDoc = document.get('image url de docteur');
                      ...
                      return Dismissible(
                        ...
                        onDismissed: (direction) async {
                          try {
                            ...
                            FirebaseFirestore.instance.collection('suivi').add({
                              'nom de docteur': nomDoc,
                              'prenom de docteur': prenomDoc,
                              'image url de docteur': imageDoc,
                              'id de docteur': idDoc,
                              'status': "acceptée",
                              'nom de patient': nom,
                              'prenom de patient': prenom,
                              'image url de patient': image,
                              'id de patient': idPatient,
                              'envoyeé le': temps,
                              'acceptée le': FieldValue.serverTimestamp(),
                            });
                            ...
                            print('Error handling dismiss action: $error');
