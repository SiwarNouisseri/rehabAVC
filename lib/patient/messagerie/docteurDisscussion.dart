...
import 'package:first/orthophoniste/messagerie/lastMess.dart';
import 'package:first/orthophoniste/messOrtho.dart';
import 'package:flutter/material.dart';

class DocDiss extends StatefulWidget {
  const DocDiss({Key? key}) : super(key: key);

  @override
  State<DocDiss> createState() => _DocDissState();
}
              ...
              return Container(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    ...
                    var idpa = document.get('id de docteur');
